...
const Profile = () => {
  ...
  const handleUpdateUsername = async () => {
    try {
      ...
      const res=await axios.post(`http://localhost:4000/api/users/update-username`, { username });
      console.log("res",res);
  ...
  const handleUpdateEmail = async () => {
    try {
      ...
      await axios.post(`http://localhost:4000/api/users/update-email`, { email });
  ...
  const handleChangePassword = async () => {
    try {
      ...
      await axios.post(`http://localhost:4000/api/users/update-password`, { oldPassword, newPassword });
